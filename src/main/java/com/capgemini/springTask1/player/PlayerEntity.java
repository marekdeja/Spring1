...
public class PlayerEntity {
	...
	public PlayerEntity(String name, String surname, String email, String password, String motto) {
		super();
		this.name = name;
	...
	public PlayerEntity(int id, String name, String surname, String email, String password, String motto, int gamesWon,
